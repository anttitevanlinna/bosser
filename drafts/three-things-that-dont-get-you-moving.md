...
My second gripe, a big, big gripe, is the conversation and mulling over what is AI native and what is not AI native.

This want to define the target state and the target culture comes in many flavors. What should the teams be like? Do we need a backlog? What's the management system? What are the personal competencies that we need to have? What is the culture, and how do we know this? There are levels and maturities.

And the same effect: you get people into the room and people have a conversation. You write things down, there's material, the material needs to be discussed. You have opinions, somebody thinks otherwise, and it just balloons.

## Anything first

The third is anything first, and then making it into a blocker: we can't do much before we have this and that handled.
...
Why this works is something I was kind of expecting, but I didn't realize the situation on the ground is so strong.
